...
async function currentCountry(){ //function to find public ip and country of client
  ...
  const currentCountry = await fetch(`https://ipinfo.io/json?token=1a0156cc74ef2b}`) //API call to ipinfo.io
...
async function currentWeather(usrLocationLatitud, usrLocationLongitud){
  ...
  const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${usrLocationLatitud}&lon=${usrLocationLongitud}&appid=de6c0474c79ad34ad40f709c9cd3d079&units=imperial`);
...
async function weatherForecast(usrLocationLatitud, usrLocationLongitud){
  const response = await fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${usrLocationLatitud}&lon=${usrLocationLongitud}&appid=de6c0474c79ad34ad40f709c9cd3d079&units=imperial&cnt=40`);
